## Frozen review packet — case 12-before
...
- issue: #12
- review base (origin/main): 6ec35460e4879b8278bc7feb680b7fbb5e84ce08
- head under review: 4830b7d95fa60fab51f8c4260ce3cc662dae4804
...
@@ -263,6 +266,7 @@ def load(start: Path | None = None) -> Config:
...
@@ -278,6 +282,10 @@ def load(start: Path | None = None) -> Config:
...
-# Only the model is configurable here; generated advice cannot execute actions.
-# model = "openai-codex/gpt-6-astra"  # unset: existing manager.command --model, then OMP default
...
@@ -266,6 +273,16 @@ class HostConfigTest(unittest.TestCase):
